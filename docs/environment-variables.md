...
- **Organization logos** (`organizations/{id}/profile/*`), **home card images** (`organizations/{id}/thumbnail/*`), and property-map uploads (`organizations/{id}/property-map/*`) use the same active bucket.
