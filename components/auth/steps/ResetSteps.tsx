...
import { Shell, AnimateStep, BackButton, AuthInput, PrimaryButton, CheckCircleIcon } from "@/components/auth/ui";
  ...
  return (
    <Shell>
      <AnimateStep stepKey="forgot-password">
        ...
        <h1 className="self-start text-3xl font-bold tracking-tight md:text-4xl">Reset password</h1>
  ...
  return (
    <Shell>
      <AnimateStep stepKey="reset-sent">
        ...
        <h1 className="text-3xl font-bold tracking-tight md:text-4xl">Check your email</h1>
