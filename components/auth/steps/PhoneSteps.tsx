  ...
  return (
    <Shell>
      <AnimateStep stepKey="phone-entry">
        ...
        <h1 className="self-start text-3xl font-bold tracking-tight md:text-4xl">Continue with phone:</h1>
  ...
  return (
    <Shell>
      <AnimateStep stepKey="phone-otp">
        ...
        <h1 className="self-start text-3xl font-bold tracking-tight md:text-4xl">Enter verification code</h1>
